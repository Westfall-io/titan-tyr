...
description: Verify the operator's titan-tyr environment is ready for write operations. Checks TITAN_TYR_URL, TITAN_TYR_TOKEN auth, X-Actor presence. Read-only.
