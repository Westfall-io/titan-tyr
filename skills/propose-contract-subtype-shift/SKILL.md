...
description: Propose a structural subtype change on an existing contract (e.g. interaction to binding, or a connection_type label swap). Acceptance via /accept-contract-proposal.
---
