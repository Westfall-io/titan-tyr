...
description: Propose a soft-delete of an existing contract — retires from the catalog with rationale + impact preview. Acceptance via /accept-contract-deletion.
---
