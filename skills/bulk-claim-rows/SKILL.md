...
description: One-shot sweep that tags every part/contract with a project tag and/or claims them under an X-Actor identity. For backfills after a new project or after X-Actor migration.
