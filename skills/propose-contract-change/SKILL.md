...
description: Propose a change to an existing titan-tyr interface contract body. Iterates -rcN versions, shows diff, POSTs proposals. Does NOT accept — use /accept-contract-proposal.
---
