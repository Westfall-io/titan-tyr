---
name: audit-skill
description: Review how a recently-invoked skill performed. Reconstructs the run from context, classifies friction/bugs/stale refs, surfaces fix suggestions.
