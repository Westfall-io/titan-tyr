...
description: Propose a structural subtype change for a registered part (correct misclassification without losing name/version/contracts). All 13 subtypes targetable.
---
