---
name: update-skills
description: Pull or check the titan-tyr skill catalog from main against local copies. Sync mode is a destructive overwrite. Plugin install is now preferred over this script.
