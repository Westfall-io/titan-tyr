...
description: Propose a change to one of titan-tyr's templates. 16 kinds spanning part subtypes + contract subtypes. Acceptance via /accept-template-proposal.
---
