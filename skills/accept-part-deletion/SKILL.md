...
description: Accept an open part deletion proposal — soft-delete the row. Human-only acceptor (not agent allowlist). Cascade flag mandatory if touching contracts exist.
---
