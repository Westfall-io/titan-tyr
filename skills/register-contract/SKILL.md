...
description: Register a new contract between two parts. Branches on subtype (interaction/binding/connection). Picks endpoints, fetches template, fills, POSTs to /contracts.
---
